...
public class AssetsLoadingScene extends AbstractMenuScene<AssetsLoadingSceneDelegate> {
    ...
    public void resume() {
        ...
        getStage().addAction(
                Actions.sequence(
                        new AssetLoadingAction(assetsController, R.drawable.helmet_astronaut_logo, Texture.class),
                        new AssetLoadingAction(assetsController, R.drawable.helmet_astronomer_logo, Texture.class),
                        new AssetLoadingAction(assetsController, R.drawable.helmet_biologist_logo, Texture.class),
                        new AssetLoadingAction(assetsController, R.drawable.helmet_engineer_logo, Texture.class),
                        new AssetLoadingAction(assetsController, R.drawable.helmet_physicist_logo, Texture.class),
                        new AssetLoadingAction(assetsController, R.drawable.helmet_semanticist_logo, Texture.class),
                        new AssetLoadingAction(assetsController, R.drawable.tool_geiger_counter_logo, Texture.class),
                        new AssetLoadingAction(assetsController, R.drawable.tool_infrared_logo, Texture.class),
                        new AssetLoadingAction(assetsController, R.drawable.tool_magnetometer, Texture.class),
                        new AssetLoadingAction(assetsController, R.drawable.tool_ohmmeter_logo, Texture.class),
                        new AssetLoadingAction(assetsController, R.drawable.tool_radio_receiver_logo, Texture.class),
                        new AssetLoadingAction(assetsController, R.drawable.tool_recording_equipment_logo, Texture.class),
                        new AssetLoadingAction(assetsController, R.drawable.tool_simple_tools_logo, Texture.class),
                        new AssetLoadingAction(assetsController, R.drawable.tool_vision_equipment_logo, Texture.class),
                        Actions.delay(3),
                        new Action() {
