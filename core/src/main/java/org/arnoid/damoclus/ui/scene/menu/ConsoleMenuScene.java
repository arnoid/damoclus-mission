...
public class ConsoleMenuScene extends AbstractMenuScene<ConsoleSceneDelegate> {

    private static final String TAG = ConsoleMenuScene.class.getSimpleName();

    private Label lblConsoleOutput;
    private TextField edtConsoleInput;

    public ConsoleMenuScene(MainComponent component) {
        super();
    ...
    protected void produceLayout() {
        setLayout(R.layout.window_console);
    }
    ...
    private void onConsoleOutputMessage(String message) {
        lblConsoleOutput.getText()
                .append("\n")
                .append(skinController.formatColoredString(message));
